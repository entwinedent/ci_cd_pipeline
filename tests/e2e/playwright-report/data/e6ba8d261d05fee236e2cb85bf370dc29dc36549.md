...
- Name: e2e-tests.spec.ts >> Error Handling Tests >> Non-existent endpoint returns 404
- Location: e2e-tests.spec.ts:69:7

# Error details

```
Error: page.goto: net::ERR_EMPTY_RESPONSE at http://localhost:8080/non-existent
Call log:
  - navigating to "http://localhost:8080/non-existent", waiting until "load"
