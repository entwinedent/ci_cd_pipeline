...
- Name: e2e-tests.spec.ts >> Service Availability Tests >> Telemetry service is reachable from browser
- Location: e2e-tests.spec.ts:52:7

# Error details

```
Error: page.goto: net::ERR_EMPTY_RESPONSE at http://localhost:8000/healthz
Call log:
  - navigating to "http://localhost:8000/healthz", waiting until "load"
