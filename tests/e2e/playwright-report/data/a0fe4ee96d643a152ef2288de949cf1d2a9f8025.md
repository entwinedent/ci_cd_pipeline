...
- Name: e2e-tests.spec.ts >> Performance Tests >> Multiple concurrent requests complete successfully
- Location: e2e-tests.spec.ts:85:7

# Error details

```
Error: page.goto: net::ERR_ABORTED at http://localhost:8080/healthz
Call log:
