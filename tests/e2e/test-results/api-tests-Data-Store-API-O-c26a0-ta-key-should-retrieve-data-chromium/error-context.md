...
- Name: api-tests.spec.ts >> Data Store API Operations >> GET /api/v1/data/{key} should retrieve data
- Location: api-tests.spec.ts:38:7
...
Call log:
  - → GET http://localhost:8080/api/v1/data/test-key-1785120013134
