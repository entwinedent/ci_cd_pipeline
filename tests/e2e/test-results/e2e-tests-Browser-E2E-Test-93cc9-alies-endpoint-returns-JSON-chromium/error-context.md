...
- Name: e2e-tests.spec.ts >> Browser E2E Tests - Telemetry Service >> Telemetry anomalies endpoint returns JSON
- Location: e2e-tests.spec.ts:37:7

# Error details

```
Error: page.goto: net::ERR_EMPTY_RESPONSE at http://localhost:8000/api/v1/anomalies
Call log:
  - navigating to "http://localhost:8000/api/v1/anomalies", waiting until "load"
