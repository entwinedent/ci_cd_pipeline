...
- Name: e2e-tests.spec.ts >> Browser E2E Tests - API Gateway >> Readiness check page loads and displays status
- Location: e2e-tests.spec.ts:13:7

# Error details

```
Error: page.goto: net::ERR_EMPTY_RESPONSE at http://localhost:8080/readyz
Call log:
  - navigating to "http://localhost:8080/readyz", waiting until "load"
